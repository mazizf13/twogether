...
export function AddSharedExpenseModal({ 
  ...
  const { data, setData, post, processing, errors, reset, clearErrors } = useForm({
    ...
    shared_expense_group_id: groupId,
  })
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    post(route('expenses.shared.store'), {
      preserveScroll: true,
      onSuccess: () => {
        onClose()
      },
  ...
  // Calculate owed amounts for display
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0">
      ...
      <div className="relative bg-white dark:bg-neutral-950 rounded-3xl shadow-xl w-full max-w-md overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
        <div className="px-6 py-4 border-b border-neutral-100 dark:border-neutral-800 flex items-center justify-between bg-white dark:bg-neutral-950 sticky top-0 z-10">
          <h2 className="text-lg font-semibold text-neutral-900 dark:text-neutral-100">Tambah Pengeluaran Bersama</h2>
          <button 
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 overflow-y-auto space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div>
              <label htmlFor="description" className="block text-sm font-medium text-neutral-700 dark:text-neutral-200 mb-1">Deskripsi (Opsional)</label>
              <input
                id="description"
                type="text"
