            ...
            <div className="w-full bg-gradient-to-br from-pink-50 to-pink-100 rounded-2xl p-8 border border-pink-200 shadow-sm relative overflow-hidden group">
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between">
                    <div className="space-y-2 mb-6 md:mb-0">
                        <h3 className="text-2xl font-serif font-bold text-pink-900">
                            When is the big day?
                        </h3>
                        <p className="text-pink-700/80 max-w-sm">
                            Atur tanggal pernikahanmu to start the countdown and
                            unlock timeline features.
                        </p>
                    </div>
                    <Link
        ...
        return (
            <div className="w-full bg-gradient-to-r from-pink-600 via-rose-500 to-pink-500 rounded-2xl p-8 text-white shadow-pink-md relative overflow-hidden animate-in zoom-in-95 duration-700">
                <div className="relative z-10 text-center space-y-4 py-4">
                    <h2 className="text-5xl md:text-6xl font-serif font-bold drop-shadow-sm">
                        {message}
                    </h2>
                ...
                <div className="absolute top-0 left-0 w-full h-full pointer-events-none">
                    <div
                        className="absolute top-4 left-10 w-4 h-4 bg-white dark:bg-neutral-950/40 rounded-full animate-bounce"
                        style={{ animationDelay: "0ms" }}
                    />
                    <div
                        className="absolute top-12 right-20 w-3 h-3 bg-white dark:bg-neutral-950/60 rounded-full animate-bounce"
                        style={{ animationDelay: "150ms" }}
                    />
                    <div
                        className="absolute bottom-10 left-1/4 w-5 h-5 bg-white dark:bg-neutral-950/30 rounded-full animate-bounce"
    ...
    return (
        <div className="w-full bg-gradient-to-br from-pink-500 to-pink-600 rounded-2xl p-6 md:p-10 text-white shadow-pink-md relative overflow-hidden flex flex-col md:flex-row md:items-end justify-between min-h-[220px]">
            ...
            <div className="relative z-10 mt-8 md:mt-0 flex space-x-3">
                {months > 0 && (
                    <div className="bg-white dark:bg-neutral-950/20 backdrop-blur-md px-4 py-3 rounded-2xl text-center min-w-[80px] shadow-sm">
                        <div className="text-2xl font-bold text-pink-600 dark:text-pink-100 tabular-nums leading-tight">
                            {months}
                        </div>
                        <div className="text-xs text-pink-600/80 dark:text-pink-100/80 font-medium">
                            Months
                        </div>
                    </div>
                )}
